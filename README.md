MrBeat is a BeatBox programm using audiostream for real time sound, you can create cool rythme, more kit can be added or you can add your kit (if you do that, you should edit sound_kit_service.py)...
